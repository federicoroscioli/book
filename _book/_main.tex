...
\includegraphics[width=1\linewidth,]{images/8psue2xkvn811}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-26-1} \includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-26-2} \includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-26-3} \caption{From top-left clockwise: Regression line GAM; Linear regression line; Facets.}\label{fig:unnamed-chunk-26}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-27-1} \caption{Paired barchart.}\label{fig:unnamed-chunk-27}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-28-1} \includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-28-2} \caption{From top-left clockwise: Labeled scatterplot; Violin plot.}\label{fig:unnamed-chunk-28}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=600px,]{images/Schermata 2022-03-28 alle 10.36.15} \caption{The six steps of data analysis.}\label{fig:unnamed-chunk-30}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-32-1} \includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-32-2} \caption{From left: Histograms of the samples a and b.}\label{fig:unnamed-chunk-32}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=180px,]{images/gini} \caption{Graphical representation of the Gini index.}\label{fig:unnamed-chunk-35}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-48-1} \includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-48-2} \caption{From left: A density distribution as outline of the hisogram; The probability that the random variable $X$ is higher than or equal to 1.5.}\label{fig:unnamed-chunk-48}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=600px,]{images/Senza titolo} \caption{The Empirical Rule.}\label{fig:unnamed-chunk-49}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-50-1} \caption{The comparison between weight and income standardized.}\label{fig:unnamed-chunk-50}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-53-1} \caption{Single Sample T-Test as plotted by gginference package.}\label{fig:unnamed-chunk-53}
\end{figure}

\includegraphics[width=350px,]{images/Schermata 2022-03-29 alle 16.14.37}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-57-1} \caption{Single Sample T-Test as plotted by gginference package.}\label{fig:unnamed-chunk-57}
\end{figure}

\includegraphics[width=400px,]{images/Schermata 2022-03-29 alle 16.36.10}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-67-1} \caption{Plot of the residuals from a regression line.}\label{fig:unnamed-chunk-67}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=350px,]{images/Schermata 2022-07-07 alle 17.24.44} \caption{Linear regression model summary output.}\label{fig:unnamed-chunk-69}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=350px,]{images/Schermata 2022-07-07 alle 18.49.38} \caption{Logistic regression model summary output.}\label{fig:unnamed-chunk-73}
\end{figure}
...
\begin{figure}[H]
\includegraphics{_main_files/figure-latex/fig2-1} \caption{Dendogram plot.}\label{fig:fig2}
\end{figure}
...
\begin{figure}[H]
\includegraphics{_main_files/figure-latex/fig3-1} \caption{K-means clustering.}\label{fig:fig3}
\end{figure}
...
\begin{figure}[H]
\includegraphics{_main_files/figure-latex/unnamed-chunk-74-1} \caption{Heatmap.}\label{fig:unnamed-chunk-74}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-77-1} \caption{Screeplot.}\label{fig:unnamed-chunk-77}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-78-1} \includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-78-2} \includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-78-3} \caption{From top-left clockwise: Graph of variables, positive correlated variables point to the same side of the plot; Graph of individuals, individuals with a similar profile are grouped together; Biplot of individuals and variables.}\label{fig:unnamed-chunk-78}
\end{figure}
...
\begin{figure}[H]
\includegraphics{_main_files/figure-latex/unnamed-chunk-79-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-79-2} \caption{From left: Pairs graph before PCA; Pairs graph after PCA.}\label{fig:unnamed-chunk-79}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=600px,]{images/classification-tree_ygvats copia} \caption{Classification tree explanation. Source Lee (2018).}\label{fig:unnamed-chunk-80}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-82-1} \includegraphics[width=0.5\linewidth,]{_main_files/figure-latex/unnamed-chunk-82-2} \caption{From left: Complexity vs X-val Relative Error; The automatically pruned CART.}\label{fig:unnamed-chunk-82}
\end{figure}

\begin{figure}[H]
\includegraphics{_main_files/figure-latex/unnamed-chunk-83-1} \caption{The manually pruned CART.}\label{fig:unnamed-chunk-83}
\end{figure}
