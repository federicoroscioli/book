...
```{r, echo=F, out.width=600, fig.show="hold"}
...
<!-- ```{r, echo=F, out.width=600, fig.show="hold", fig.cap="Select the version of R according to your operating system."} -->
...
<!-- ```{r, echo=F, out.width=600, fig.show="hold", fig.cap="Select the version of R-Studio according to your operating system."} -->
...
<!-- ```{r, echo=F, out.width=600, fig.show="hold", fig.cap="R-Studio."} -->
