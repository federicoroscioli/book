...
```{r, echo=F, out.width=600, fig.show="hold", fig.cap="Classification tree explanation. Source Lee (2018)."}
...
$$ 
where
$x_{ij}$ is the value of the indicator $j$ for the unit $i$ and
...
$$ 
where
$cv_i=\frac{S_{r_i}}{M_{r_i}}$ is the coefficient of variation of the
