...
Download the [wine dataset](http://www.federicoroscioli.com/wp-content/uploads/2021/02/Wine.csv), change the directory below with the folder where you put the downloaded
file, and try to import it (it is a text based csv file). Try the same with the [village dataset](http://www.federicoroscioli.com/wp-content/uploads/2022/03/Village.xlsx), be aware that this one is in Excel format.
...
-   James, G., Witten, D., Hastie, T., & Tibshirani, R. (2021). An
    ...
    [Available here](https://www.statlearning.com). Chapter 2.4 exercises 8, 9, and 10.
-   [R playground](https://federicoroscioli.shinyapps.io/exercises/), A, B, C

\newpage


<!--chapter:end:02_abc.Rmd-->
...
```{r, out.width='80%',fig.align="center", fig.show='hold', fig.cap="Paired barchart."}
# creating data
people <- data.frame(name = c("Mary", "Mike", "Greg"),
                     surname = c("Wilson", "Jones", "Smith"),
                     age = c(44, 52, 46),
...
The [Ggplot2 Cheatsheet](https://rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf) gives us some of the most important options. I strongly suggest to look
...
```{r, echo=F, out.width="80%",fig.align="center", fig.show="hold", fig.cap="The six steps of data analysis."}
...
```{r, echo=F, out.width="50%", fig.show="hold", fig.align = 'center', fig.cap="Graphical representation of the Gini index."}
