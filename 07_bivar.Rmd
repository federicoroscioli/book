...
```{r, echo=F, out.width=350, fig.show="hold", fig.cap="Linear regression model summary output."}
...
```{r, echo=F, out.width=350, fig.show="hold", fig.cap="Logistic regression model summary output."}
